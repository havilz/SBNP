...
const WS_URL = `${window.location.origin}/sbnp`;
...
async function loadInitialData() {
    ...
    try {
        ...
        console.log(`Data received: ${data.length} stations found.`);
        if (data.length > 0) {
            console.log('Sample Station Pos:', data[0].latitude, data[0].longitude);
        }
        ...
        .bindPopup(`
            <div style="min-width: 150px">
                ...
                <div style="font-size: 0.8rem; color: #94a3b8">
                    ...
                    <p>Status: <b style="color: ${isOff ? '#f87171' : '#4ade80'}">${data.status.label}</b></p>
